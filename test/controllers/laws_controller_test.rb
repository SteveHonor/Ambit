...
class LawsControllerTest < ActionController::TestCase
  ...
  test "should create law" do
    assert_difference('Law.count') do
      post :create, law: { article: @law.article, description: @law.description, number: @law.number }
    end
  ...
  test "should update law" do
    patch :update, id: @law, law: { article: @law.article, description: @law.description, number: @law.number }
    assert_redirected_to law_path(assigns(:law))
  end
