...
class SupervisionsControllerTest < ActionController::TestCase
  ...
  test "should create supervision" do
    assert_difference('Supervision.count') do
      post :create, supervision: { notification_id: @supervision.notification_id, observation: @supervision.observation }
    end
  ...
  test "should update supervision" do
    patch :update, id: @supervision, supervision: { notification_id: @supervision.notification_id, observation: @supervision.observation }
    assert_redirected_to supervision_path(assigns(:supervision))
  end
